...
let
  sources = {
    ...
    "@tailwindcss/postcss7-compat-2.1.4" = {
      ...
      version = "2.1.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@tailwindcss/postcss7-compat/-/postcss7-compat-2.1.4.tgz";
        sha512 = "KYRj/AGNwE4tPf02IvT+J36Twlrwg/OJJuSckSupX2T+xIOHSXPugNJZ7Stn9F67hh/qH+2Y2HXK6vpBadW6qw==";
      };
    };
    "@types/glob-7.1.3" = {
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."@tailwindcss/postcss7-compat-2.1.4" // {
        dependencies = [
